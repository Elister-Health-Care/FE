            ...
            <div className="shadow bg-white row my-4 border-0 rounded-3 body-register overflow-hidden">
              <div className=" pt-4 pb-4 pl-5 pr-5 col-md-7 col-lg-7">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <label for="floatingInputEmail">Email: (<span className="text-danger">*</span>)</label>
                  <div className=" mb-2 ">
                    <input
                      onChange={handleInputChange}
                  ...
                  <div className=" mb-2 ">
                    <div className="row">
                      <div className="col-6 mr-0 pr-1">
                        <label for="password">Mật khẩu: (<span className="text-danger">*</span>)</label>
                        <input
                          onChange={handleInputChange}
                  ...
                  <div className="col-sm-12 pt-2 mb-2">
                    <div className="row">
                      ...
                      <label for="">Giới tính: (<span className="text-danger">*</span>)</label>
                      ...
                      <div className="col-lg-6 ml-0 pl-0 col-md-6">
                        <div className=" mb-2 ">
                        <label for="">Ngày sinh: (<span className="text-danger">*</span>)</label>
                          <input
                            onChange={handleInputChange}
                            defaultValue={formData.date_of_birth}
                            name="date_of_birth"
              ...
              <div className="card-img-left d-none m-auto d-md-block col-lg-5 col-md-5">
                <img src="/blog/image/register-photo.png" className="w-100 " />
              </div>
            </div>
          </div>
        </div>
