            ...
            <div className="infor-hospital">
                  ...
                  {dayOfWeek.map((day)=>(
                    ...
                    <p className="time">
                     { timeWork[day].enable == true ? ( 
                      ...
                      timeWork[day].morning.time[0] + "-" + timeWork[day].morning.time[1] : "Đóng cửa") 
                      + ", " +
                      (timeWork[day].afternoon.enable == true ? 
                      timeWork[day].afternoon.time[0] + "-" + timeWork[day].afternoon.time[1] : "Đóng cửa") 
                      + ", " +
                      (timeWork[day].night.enable == true ? 
                      timeWork[day].night.time[0] + "-" + timeWork[day].night.time[1] : "Đóng cửa")
                      ) : "Đóng cửa" }   
                    </p>  
                    </div>
                  ))}                  
              ...
              <div className="description">
                      ...
                      <Accordion.Body>
                        <div className="service-body">
                          ...
                          <div className="service-fee">
                            ...
                            <p className="fee-desc">Phí tư vấn trong khoảng</p>
                            <p className="fee">{formatMoney(services.price_hospital_service)}</p>
                          </div>
                        </div>
                      </Accordion.Body>
                    </Accordion.Item>
                ...
                <div className="instruction">
                  ...
                  <p>• Khi tiến hành đặt lịch khám, quý bệnh nhân sẽ nhận được email xác nhận đặt lịch từ Hello Bacsi. Trong quá trình lấy số và đăng ký thông tin khám bệnh, có thể đưa email này cho đội ngũ lễ tân/nhân viên y tế.</p>
                   <p>
                   • Quy trình thăm khám tại bệnh viện:</p>
                   <ul>
                      <li><b>Bước 1:</b> Quý khách đến trực tiếp quầy tiếp đón ấn nút màu xanh có chữ “Tiếp nhận” để đăng ký khám bệnh. Trường hợp khám theo BHYT, quý khách nhấn nút màu cam có chữ “Bảo hiểm”.</li>
                      <li><b>Bước 2:</b> Lấy số thứ tự và ngồi chờ tới lượt khám.</li>
                      <li><b>Bước 3:</b> Khám lâm sàng và thực hiện một số kiểm tra theo chỉ định của bác sĩ (nếu có).</li>
                      <li><b>Bước 4:</b> Đến quầy nhận thuốc và thanh toán chi phí.</li>
                    </ul> 
                    <p><b>Lưu ý: </b> 
                      <span className="text-danger">
                        Các bước khám chữa bệnh có thể thay đổi tùy thuộc vào yêu cầu từ phía bác sĩ đối với từng trường hợp bệnh khác nhau.
                      </span> 
                    </p>
                </div>
              </div>
